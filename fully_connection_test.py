...
def paddingShortAudio(file_name, sizeVector):
    files_path = (r'C:\Users\User\PycharmProjects\pythonProject1\test')
    ...
    scipy.io.wavfile.write("medianTest/" + file_name + 'newSong.wav', sr, y)
...
def cutLongAudio(file_name, median):
    ...
    newAudio.export("medianTest/" + file_name + 'newSong.wav', format="wav")


def calculateMedian():
    directory = (r'C:\Users\User\PycharmProjects\pythonProject1\test')
    arrayDuration = []
